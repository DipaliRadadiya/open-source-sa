...
return [
    ...
    'ip_ignored' => 'その IP アドレスは除外リストに登録されています。本当にブロックする場合は、先に除外リストから削除してください。',
    'ip_own_address' => 'これはこのサーバー自身のアドレスです。ブロックするとパネルがデータベースから切り離され、アクセスできなくなるおそれがあるため、許可されていません。',
