...
return [
    ...
    'frequency' => [
        ...
        'every_3_hours' => '3時間ごと',
        'every_6_hours' => '6時間ごと',
        'every_12_hours' => '12時間ごと',
        'daily' => '毎日',
        'weekly' => '毎週',
        'monthly' => '毎月',
    ],
    'frequency_hint' => [
        'manual' => '手動で開始したときだけ実行されます。',
        'hourly' => '毎時、指定した分に実行されます。',
        'every_3_hours' => '指定した時刻と、その前後 3 時間ごとに一日中実行されます。',
        'every_6_hours' => '指定した時刻と、その前後 6 時間ごとに一日中実行されます。',
        'every_12_hours' => '指定した時刻と、その 12 時間後に実行されます。',
        'daily' => '毎日、指定した時刻に 1 回実行されます。',
        'weekly' => '毎週日曜日の指定した時刻に実行されます。',
        'monthly' => '毎月 1 日の指定した時刻に実行されます。',
    ],
    'errors' => [
        ...
        'upload_stalled' => 'アップロードがデータ送信を停止したため中断されました。接続は開いたままでしたがまったく転送されておらず、通常はストレージプロバイダ側が切断したことを意味します。保存先に問題はありません。次回の定期実行で再試行します。',
        'download_not_supported' => 'この保存先タイプではダウンロードを利用できません。パネルがブラウザにリンクを渡せるのは、ストレージ提供元がそれに対応している場合だけです（Amazon S3 と Google Drive のご自身のアカウントが該当します）。このバックアップからの復元は通常どおり機能します。',
        'unknown' => '不明な理由でバックアップに失敗しました。',
        'crashed' => 'バックアップが予期せず停止しました。完了する前にプロセスが強制終了されています。多くの場合、サーバーのメモリ不足か、途中でワーカーが再起動されたことが原因です。',
        'abandoned' => 'このバックアップは応答がないまま終了扱いになりました。ワーカーが失われているため、何もアップロードされていません。',
        'clear_not_running' => 'このバックアップは実行中ではないため、消去するものはありません。',
        'clear_too_soon' => 'このバックアップはまだ実行中の可能性があります。ワーカーからの応答がない場合、開始から :minutes 分後に自動的に終了扱いになります。',
