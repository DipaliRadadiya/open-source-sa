...
return [
    ...
    'errors' => [
        ...
        'basedir_absolute' => 'パスは / で始まる絶対パスである必要があります。「:path」は絶対パスではありません。',
        'basedir_root' => '「/」はファイルシステム全体を許可するため、open_basedir が有効なのに何も制限しない状態になります。代わりに設定をオフにしてください。',
        'basedir_traversal' => '「:path」は使用できません — パスに「..」を含めることはできません。',
