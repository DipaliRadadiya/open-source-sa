...
return [
    ...
    'reasons' => [
        ...
        'folder_taken' => 'パネル内の別のサイトがすでにこの名前のフォルダーを使用しています。フォルダー名は一意である必要があるため、このサイトはそのままにしました。サイトは引き続き公開されています。',
        'folder_name_unusable' => 'このサイトのフォルダー名には、パネルがファイル名に使用できない文字が含まれているため、そのままにしました。サイトは引き続き公開されています。',
        ...
        'after_sites_adopted' => 'このプレビューで新しいサイトが見つかりました。それらのワーカー、SSL 証明書、PHP 設定はサイトの同期後に表示されます。同期を適用すると、まずサイトが取り込まれ、その後にこれらが読み込まれます。',
    ],
