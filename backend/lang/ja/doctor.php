...
return [
    ...
    'fixes' => [
        'home_open' => 'システムユーザーのホームが他のすべてのローカルアカウントに開かれているため、そのサイトが通常の権限で書き込んだファイル（セッション、.env ファイル、データベースファイル）を他のサイトのユーザーが読めます。`php artisan sites:resync` を実行してください。acl パッケージがなければインストールし、パネルとウェブサーバー以外にはホームを閉じます。',
