...
return [
    ...
    */
    'failure_reason' => [
        ...
        'no_build_tools' => 'このステップではネイティブモジュールのコンパイルが必要でしたが、このサーバーにはコンパイラがインストールされていません。ビルドツールをインストールするか、LTS版のNodeでサイトを作成してください。LTS版は通常ビルド済みバイナリを同梱しており、コンパイラを必要としません。',
    ],
