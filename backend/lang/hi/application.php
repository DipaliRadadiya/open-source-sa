...
return [
    ...
    'unavailable' => [
        ...
        'php_version_install' => 'इस सर्वर पर ऐसा कोई PHP संस्करण नहीं है जिस पर :type चलता है (:range)। पहले PHP स्क्रीन से PHP :version इंस्टॉल करें।',
        'php_version_none' => 'इस सर्वर पर ऐसा कोई PHP संस्करण नहीं है जिस पर :type चलता है (:range), और इनमें से कोई भी संस्करण सर्वर की पैकेज रिपॉज़िटरी से इंस्टॉल नहीं किया जा सकता।',
    ...
    */
    ...
    'steps' => [
        ...
        'create_admin' => 'एडमिन खाता बनाया जा रहा है',
        'schedule_cron' => 'बैकग्राउंड जॉब शेड्यूल की जा रही हैं',
    ...
    */
    ...
    'failure_reason' => [
        ...
        'owner_not_created' => 'एप्लिकेशन शुरू हो गया, लेकिन उसके एडमिन की पुष्टि नहीं हो सकी। साइट सौंपी नहीं गई, क्योंकि जब तक कोई एडमिन नहीं है, इसे खोलने वाला कोई भी व्यक्ति एडमिन बना सकता है। फिर से कोशिश करें; अगर यह बार-बार विफल हो, तो एप्लिकेशन लॉग देखें।',
        'app_not_ready' => 'एप्लिकेशन शुरू हो गया, लेकिन 2 मिनट में पूरी तरह शुरू नहीं हुआ, इसलिए उसका एडमिन नहीं बनाया जा सका। एप्लिकेशन लॉग देखें, फिर से कोशिश करें।',
    ...
    'webhook_registration' => [
        'no_account' => 'यह साइट कनेक्ट किए गए Git अकाउंट से नहीं, बल्कि एक पब्लिक URL से डिप्लॉय होती है, इसलिए पैनल आपके लिए वेबहुक नहीं जोड़ सकता। नीचे दिए URL और सीक्रेट से इसे रिपॉज़िटरी सेटिंग्स में जोड़ें।',
        'signing_token' => 'GitLab साइनिंग टोकन खुद बनाता है, इसलिए पैनल आपके लिए यह वेबहुक नहीं जोड़ सकता। नीचे दिए URL और अपने साइनिंग टोकन से इसे रिपॉज़िटरी की Webhooks सेटिंग्स में जोड़ें।',
        'not_public' => 'पैनल का पता इंटरनेट से पहुँचने योग्य नहीं है, इसलिए GitHub, GitLab या Bitbucket उस तक डिलीवर नहीं कर पाएँगे। पैनल को पब्लिक पता दें, या उसके बाद वेबहुक हाथ से जोड़ें।',
        'provider_refused' => 'Git प्रोवाइडर ने पैनल को वेबहुक जोड़ने नहीं दिया। शायद कनेक्ट किए गए टोकन के पास इस रिपॉज़िटरी के वेबहुक संभालने की अनुमति नहीं है। नीचे दिए URL और सीक्रेट से इसे हाथ से जोड़ें, या उस अनुमति के साथ अकाउंट फिर से कनेक्ट करें।',
    ],
];
