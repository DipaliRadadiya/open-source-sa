...
return [
    ...
    'reasons' => [
        ...
        'folder_taken' => 'पैनल में कोई दूसरी साइट पहले से इसी नाम का फ़ोल्डर इस्तेमाल करती है। फ़ोल्डर के नाम अलग-अलग होने चाहिए, इसलिए इसे वैसे ही छोड़ दिया गया। साइट अब भी चल रही है।',
        'folder_name_unusable' => 'इस साइट के फ़ोल्डर के नाम में ऐसे अक्षर हैं जिन्हें पैनल फ़ाइल नामों में इस्तेमाल नहीं कर सकता, इसलिए इसे वैसे ही छोड़ दिया गया। साइट अब भी चल रही है।',
        ...
        'after_sites_adopted' => 'इस प्रीव्यू में नई साइटें मिलीं। उनके वर्कर, SSL सर्टिफ़िकेट और PHP सेटिंग्स साइटें सिंक होने के बाद दिखेंगी: सिंक लागू करने पर पहले साइटें जोड़ी जाती हैं, फिर ये पढ़े जाते हैं।',
    ],
