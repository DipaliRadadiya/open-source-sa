...
return [
    ...
    'swap_below_minimum' => 'Swap kann auf diesem Server nicht unter :minimum MB liegen. Beim Update baut das Panel sein eigenes Frontend, und dafür braucht es :required MB aus Arbeitsspeicher und Swap zusammen — darunter wird das Update mittendrin abgebrochen. Erweitern Sie den RAM, oder setzen Sie SERVER_SWAP_ENFORCE_MINIMUM=false, wenn Sie den Swap dieses Servers selbst verwalten.',
];
