...
return [
    ...
    'databases_not_managed' => 'Dieser Server verwaltet keine Datenbanken. Er führt Container aus, und eine Anwendung, die eine Datenbank benötigt, bringt ihre eigene mit.',
