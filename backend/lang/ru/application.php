...
return [
    ...
    */
    ...
    'failure_reason' => [
        ...
        'no_build_tools' => 'На этом шаге требовалось скомпилировать нативный модуль, а на сервере не установлен компилятор. Установите инструменты сборки или создайте сайт на LTS-версии Node — они обычно поставляются с готовыми бинарными файлами и не требуют компилятора.',
