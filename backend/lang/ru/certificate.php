...
return [
    ...
    'failed' => [
        ...
        'dry_run_skipped' => 'certbot решил, что существующий сертификат не нуждается в обновлении, поэтому ничего не проверялось. Этот запуск ничего не доказал — это ошибка панели, а не вердикт о вашем домене.',
