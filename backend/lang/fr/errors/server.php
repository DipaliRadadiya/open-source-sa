...
return [
    ...
    'databases_not_managed' => 'Ce serveur ne gère pas de bases de données. Il exécute des conteneurs, et une application qui a besoin d\'une base de données apporte la sienne.',
