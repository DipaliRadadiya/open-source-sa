...
return [
    ...
    'setting.security_updates_started' => 'A lancé l’installation des mises à jour de sécurité',
    'setting.security_updates_installed' => 'A installé les mises à jour de sécurité',
    'setting.security_updates_failed' => 'L’installation des mises à jour de sécurité a échoué',
    ...
    'panel_update.succeeded' => 'A mis à jour le panneau de :from_version vers :to_version',
    'php.uninstall_failed' => 'PHP :version n\'a pas pu être supprimé',
    'storage_destination.connected' => 'A connecté la destination de sauvegarde :name',
    'storage_destination.created' => 'A ajouté la destination de sauvegarde :name',
    'storage_destination.updated' => 'A mis à jour la destination de sauvegarde :name',
    'storage_destination.deleted' => 'A supprimé la destination de sauvegarde :name',
    'setting.reboot_cancelled' => 'A annulé le redémarrage programmé du serveur',
    'php.ioncube_install_started' => 'A lancé l\'installation du chargeur ionCube pour PHP :version',
    'php.ioncube_installed' => 'A installé le chargeur ionCube pour PHP :version',
    'php.ioncube_install_failed' => 'Le chargeur ionCube n\'a pas pu être installé pour PHP :version',
    'php.ioncube_removed' => 'A supprimé le chargeur ionCube de PHP :version',
    ...
    'php.extension_installed' => 'A installé l\'extension :extension pour PHP :version',
    ...
    'database.attached' => 'A rattaché la base de données :name à :application',
    'database.detached' => 'A détaché la base de données :name de :application',
    ...
    'database.phpmyadmin_signed_in' => 'A ouvert :name dans phpMyAdmin en tant que :username',
    'database.process_killed' => 'A arrêté le processus :process de :engine',
    'build_tools.install_started' => 'Installation des outils de compilation démarrée',
    'build_tools.installed' => 'Outils de compilation installés',
    'build_tools.install_failed' => 'Échec de l\'installation des outils de compilation',
    ...
    'application.domain_updated' => 'Domaine mis à jour :domain (:type)',
    ...
    'application.site_type_changed' => 'Type de :name changé de :from à :to',
