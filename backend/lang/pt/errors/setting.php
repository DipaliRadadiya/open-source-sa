...
return [
    ...
    'database_unreachable' => 'O painel não consegue conectar-se ao servidor de base de dados, por isso esta alteração não foi aplicada.',
    'database_absent' => 'Nenhum servidor MySQL ou MariaDB está instalado nesta máquina.',
];
