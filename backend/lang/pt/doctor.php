...
return [
    'checks' => [
        ...
        'home_access' => 'Acesso às pastas pessoais',
    ...
    'fixes' => [
        'home_open' => 'A pasta pessoal de um utilizador do sistema está aberta a todas as outras contas locais, pelo que qualquer ficheiro que os seus sites escreveram com permissões normais — sessões, ficheiros .env, bases de dados — pode ser lido pelo utilizador de qualquer outro site. Execute `php artisan sites:resync`: instala o pacote acl se faltar e fecha cada pasta pessoal a todos exceto ao painel e ao servidor web.',
