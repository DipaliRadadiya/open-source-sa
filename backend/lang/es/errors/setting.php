...
return [
    ...
    'database_unreachable' => 'El panel no puede conectarse al servidor de base de datos, así que este cambio no se aplicó. {engine} está instalado y en ejecución, pero las credenciales guardadas del panel son rechazadas: configúralas en Bases de datos y vuelve a intentarlo.',
    'database_absent' => 'No hay ningún servidor MySQL o MariaDB instalado en esta máquina.',
];
