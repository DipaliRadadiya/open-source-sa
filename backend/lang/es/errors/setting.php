...
return [
    ...
    'swap_below_minimum' => 'El swap no puede bajar de :minimum MB en este servidor. Al actualizarse, el panel compila su propio frontend, y eso necesita :required MB entre memoria y swap; por debajo de esa cifra la actualización muere a medio camino. Amplíe la RAM, o defina SERVER_SWAP_ENFORCE_MINIMUM=false si usted mismo gestiona el swap de este servidor.',
];
