...
return [
    ...
    'setting.security_updates_started' => 'Started installing security updates',
    'setting.security_updates_installed' => 'Installed security updates',
    'setting.security_updates_failed' => 'Installing security updates failed',
    ...
    'panel_update.succeeded' => 'Updated the panel from :from_version to :to_version',
    'php.uninstall_failed' => 'PHP :version could not be removed',
    'storage_destination.connected' => 'Connected the :name backup destination',
    'storage_destination.created' => 'Added the :name backup destination',
    'storage_destination.updated' => 'Updated the :name backup destination',
    'storage_destination.deleted' => 'Removed the :name backup destination',
    'setting.reboot_cancelled' => 'Cancelled the scheduled server reboot',
    'php.ioncube_install_started' => 'Started installing the ionCube Loader for PHP :version',
    'php.ioncube_installed' => 'Installed the ionCube Loader for PHP :version',
    'php.ioncube_install_failed' => 'The ionCube Loader could not be installed for PHP :version',
    'php.ioncube_removed' => 'Removed the ionCube Loader from PHP :version',
    ...
    'php.extension_installed' => 'Installed the :extension extension for PHP :version',
    ...
    'build_tools.install_started' => 'Started installing the build tools',
    'build_tools.installed' => 'Installed the build tools',
    'build_tools.install_failed' => 'Build tools installation failed',
    ...
    'application.git_account_relinked' => 'Re-linked the git account for :name',
    ...
    'log.cleared' => 'Cleared the :log log',
    ...
    'application.directory_created' => 'Created :path on :name',
    'application.file_renamed' => 'Renamed :path to :target on :name',
    'application.file_copied' => 'Copied :path to :target on :name',
