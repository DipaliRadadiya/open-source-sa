 ...
 * `sites:resync` closes homes on every deploy, so one found open is one it
 * could not close — setfacl missing, or the web server's account unknown —
 * or one reopened with `homes:open`.
 *
 * Read-only, like SiteRootLockCheck: closing a home changes who can reach a
 * user's sites, and a health check is the wrong place to decide that.
 */
